		...
		echo'
			<div class="col-75">
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Wait for an M-PESA message. Send us the transaction ID and the name of your location and your order will be shipped immediately" class="checkout-btn">
				</form>
				</div>
			</div>
			';
